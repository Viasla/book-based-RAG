...
$$\int _ { E _ { i j } } ( s + t ) \ d \mu & = ( \alpha _ { i } + \beta _ { j } ) \mu ( E _ { i j } ) \\ \int _ { E _ { i j } } s \ d \mu + \int _ { E _ { i j } } t \ d \mu & = \alpha _ { i } \, \mu ( E _ { i j } ) + \beta _ { j } \, \mu ( E _ { i j } ) . \\ \intertext { w i t h F i n p l a c e o f Y S i n c e Y i s o n }$$
...
$$\rightarrow \left | \begin{matrix} f \, d \mu & \ a s \ n \rightarrow \infty . \\ \end{matrix} \right |$$
...
$$| A _ { E } ( f ) - \alpha | = \frac { 1 } { \mu ( E ) } \left | \, \int _ { E } ( f - \alpha ) \, d \mu \, \right | \leq \frac { 1 } { \mu ( E ) } \int _ { E } | \, f - \alpha | \, d \mu \leq r ,$$
...
$$( a ) & & \lim \sup _ { n \to \infty } ( - a _ { n } ) = - \liminf _ { n \to \infty } a _ { n } . \\ ( b ) & & \lim \sup _ { n \to \infty } ( a _ { n } + b _ { n } ) \leq \lim \sup _ { n \to \infty } a _ { n } + \lim \sup _ { n \to \infty } b _ { n } .$$
...
$$\exp \left \{ \left | \log g \, d \mu \right \} \leq \left | \, g \, d \mu \, \right |$$
...
$$& , \text { where } \sum \alpha _ { i } = 1 , \text { then we obtain } \\ & y _ { n } ^ { \alpha _ { i } } \leq \alpha _ { 1 } y _ { 1 } + \alpha _ { 2 } \, y _ { 2 } + \cdots + \alpha _ { n } \, y _ { n }$$
...
$$p \ d \mu \Big \} ^ { 1 / p } + \left \{ \left \{ \int _ { X } g ^ { p } \ d \mu \right \} ^ { 1 / p } .$$
